...
class LeafDiseaseDetector:
    ...
    def create_analysis_prompt(self) -> str:
        return """
IMPORTANT: Analyze the provided image and respond strictly in this JSON format without any explanations or extra text:

{
    "disease_detected": true/false,
    "disease_name": "name of disease or null",
    "disease_type": "fungal/bacterial/viral/pest/nutrient deficiency/healthy/invalid_image",
...
For non-leaf images (humans, animals, objects), return:
{
